...
def build_resnet(arch_name="resnet18", num_classes=1000):
    if arch_name == "resnet18":
        model = ResNet(block=BasicBlock, layers=[2, 2, 2, 2], num_classes=num_classes, zero_init_residual=True)
    elif arch_name == "resnet34":
        model = ResNet(block=BasicBlock, layers=[3, 4, 6, 3], num_classes=num_classes, zero_init_residual=True)
    elif arch_name == "resnet50":
        model = ResNet(block=BottleNeck, layers=[3, 4, 6, 3], num_classes=num_classes, zero_init_residual=True)
    elif arch_name == "resnet101":
        model = ResNet(block=BottleNeck, layers=[3, 4, 23, 3], num_classes=num_classes, zero_init_residual=True)
    else:
